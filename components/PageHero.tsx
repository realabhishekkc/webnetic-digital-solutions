    ...
    <section className="container-page mt-6">
      <div className="relative overflow-hidden rounded-3xl border border-hairline">
        ...
        >
          ...
          {eyebrow && (
            <span className="inline-flex w-fit max-w-full items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs font-medium uppercase tracking-[0.18em] text-brand-bright">
              {eyebrow}
            </span>
          )}
